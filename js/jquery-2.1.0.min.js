/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (
        ...
        for (
          ...
          if (null != (e = arguments[u]))
            for (t in e)
              (n = a[t]),
                a !== (r = e[t]) &&
                  (c && r && (o.isPlainObject(r) || (i = o.isArray(r)))
                    ? (i
                        ? ((i = !1), (s = n && o.isArray(n) ? n : []))
                        : (s = n && o.isPlainObject(n) ? n : {}),
                      (a[t] = o.extend(c, s, r)))
                    : void 0 !== r && (a[t] = r));
        return a;
      }),
  ...
  var t = (function (e) {
    ...
    try {
      A.apply((j = L.call($.childNodes)), $.childNodes),
      ...
      return (function e(t, i, o, a) {
        ...
        if (!a && 1 === h.length) {
          if (
            ...
            if (!(i = (r.find.ID(c.matches[0].replace(ee, et), i) || [])[0]))
              return o;
          ...
          for (
            ...
            if (
              (p = r.find[f]) &&
              (a = p(
                c.matches[0].replace(ee, et),
                (K.test(l[0].type) && ep(i.parentNode)) || i
              ))
            ) {
              if ((l.splice(u, 1), !(t = a.length && eg(l))))
                return A.apply(o, a), o;
              break;
            }
        }
        ...
        return i !== f && 9 === i.nodeType && i.documentElement
          ? ((f = i),
            ...
            (r.find.TAG = n.getElementsByTagName
              ? function (e, t) {
                  return typeof t.getElementsByTagName !== N
            ...
            (r.find.CLASS =
              n.getElementsByClassName &&
              function (e, t) {
                return typeof t.getElementsByClassName !== N && d
    ...
    ((r = er.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(ee, et)),
              (e[3] = (e[4] || e[5] || "").replace(ee, et)),
              "~=" === e[2] && (e[3] = " " + e[3] + " "),
              e.slice(0, 4)
            );
          },
      ...
      return (
        ...
        eo(function (o, s, a, u) {
          var l,
            ...
            m = n ? (i || (o ? e : h || r) ? [] : s) : v;
          if ((n && n(v, m, a, u), r))
            for (l = ey(m, d), r(l, [], a, u), c = l.length; c--; )
              (f = l[c]) && (m[d[c]] = !(v[d[c]] = f));
          if (o) {
            if (i || e) {
              if (i) {
  ...
  (o.filter = function (e, t, n) {
    ...
    o.fn.extend({
      find: function (e) {
        ...
        return (
          ((r = this.pushStack(n > 1 ? o.unique(r) : r)).selector = this
            .selector
            ? this.selector + " " + e
            : e),
          r
      ...
      is: function (e) {
        return !!x(this, "string" == typeof e && u.test(e) ? o(e) : e || [], !1)
          .length;
      },
    });
  var y,
    ...
    if ("string" == typeof e) {
      ...
      if (n[1]) {
        if (
          ...
          o.merge(
            this,
            o.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : m, !0)
          ),
          v.test(n[1]) && o.isPlainObject(t))
        )
          for (n in t)
            o.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
        return this;
      }
      return (
        (r = m.getElementById(n[2])) &&
          r.parentNode &&
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            i = this.length,
            s = [],
            a = u.test(e) || "string" != typeof e ? o(e, t || this.context) : 0;
          i > r;
          r++
        )
          for (n = this[r]; n && n !== t; n = n.parentNode)
            if (
              ...
              (a
                ? a.index(n) > -1
                : 1 === n.nodeType && o.find.matchesSelector(n, e))
            ) {
              s.push(n);
              break;
            }
      ...
      function (e, t) {
        o.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 && (C[e] || o.unique(i), B.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (o.Callbacks = function (e) {
    ...
    var t,
      ...
      p = function (t) {
        for (
          r = e.memory && t, i = !0, l = a || 0, a = 0, u = c.length, s = !0;
          c && u > l;
          l++
        )
        ...
        (s = !1),
          c && (f ? f.length && p(f.shift()) : r ? (c = []) : d.disable());
      },
      d = {
        add: function () {
          if (c) {
          ...
          return (
            c &&
              o.each(arguments, function (e, t) {
                for (var n; (n = o.inArray(t, c, n)) > -1; )
                  c.splice(n, 1), s && (u >= n && u--, l >= n && l--);
              }),
            this
          );
        },
  ...
  var J = (o.access = function (e, t, n, r, i, s, a) {
    var u = 0,
      ...
      c = null == n;
    if ("object" === o.type(n))
      for (u in ((i = !0), n)) o.access(e, t, u, n[u], !0, s, a);
    else if (
      void 0 !== r &&
      ((i = !0),
      o.isFunction(r) || (a = !0),
    ...
    (K.prototype = {
      ...
      remove: function (e, t) {
        ...
        if (void 0 === t) this.cache[s] = {};
          ...
          for (
            o.isArray(t)
              ? (r = t.concat(t.map(o.camelCase)))
              : ((i = o.camelCase(t)),
                (r =
                  (t in a) ? [t, i] : ((r = i) in a) ? [r] : r.match(E) || [])),
              n = r.length;
            n--;
    ...
    o.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = M.get(s)), 1 === s.nodeType && !L.get(s, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              0 === (r = a[n].name).indexOf("data-") &&
                P(s, (r = o.camelCase(r.slice(5))), i[r]);
  ...
  var b,
    ...
    S = function (e, t) {
      return (
        (e = t || e),
        "none" === o.css(e, "display") || !o.contains(e.ownerDocument, e)
      );
    },
    T = /^(?:checkbox|radio)$/i;
  ((b = m
  ...
  (o.event = {
        ...
        for (
          n.handler && ((n = (s = n).handler), (i = s.selector)),
            ...
            (a = m.handle) ||
              (a = m.handle =
                function (t) {
                  return "function" !== U && o.event.triggered !== t.type
          ...
          (h = v = (u = Y.exec(t[c]) || [])[1]),
            ...
            h &&
              ...
              (d = l[h]) ||
                ...
                (p.setup && !1 !== p.setup.call(e, r, g, a)) ||
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          ...
          ((e = e[o.expando]
            ? e
            : new o.Event(h, "object" == typeof e && e)).isTrigger = r ? 2 : 3),
          (e.namespace = g.join(".")),
        ...
        if (!r && !p.noBubble && !o.isWindow(n)) {
          for (
            l = p.delegateType || h, X.test(l + h) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            d.push(s), (u = s);
        ...
        for (i = 0; (s = d[i++]) && !e.isPropagationStopped(); )
          (e.type = i > 1 ? l : p.bindType || h),
            (f = (L.get(s, "events") || {})[e.type] && L.get(s, "handle")) &&
              f.apply(s, t),
            (f = c && s[c]) &&
              f.apply &&
              o.acceptData(s) &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = o.event.handlers.call(this, e, l), t = 0;
          ...
          for (
            ...
            (!e.namespace_re || e.namespace_re.test(s.namespace)) &&
              ...
              void 0 !==
                (r = (
                  (o.event.special[s.origType] || {}).handle || s.handler
                ).apply(i.elem, u)) &&
                !1 === (e.result = r) &&
      ...
      if (u && l.nodeType && (!e.button || "click" !== e.type)) {
        for (; l !== this; l = l.parentNode || this)
          if (!0 !== l.disabled || "click" !== e.type) {
            for (r = [], n = 0; u > n; n++)
              void 0 === r[(i = (s = t[n]).selector + " ")] &&
                (r[i] = s.needsContext
                  ? o(i, this).index(l) >= 0
                  : o.find(i, this, null, [l]).length),
                r[i] && r.push(s);
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            W.test(i) ? this.mouseHooks : V.test(i) ? this.keyHooks : {}),
      ...
      o.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        o.event.special[t] = {
          ...
          teardown: function () {
            ...
            i
              ? L.access(r, t, i)
              : (r.removeEventListener(e, n, !0), L.remove(r, t));
          },
        };
      }),
    o.fn.extend({
  ...
  function jb(e, t) {
    return o.nodeName(e, "table") &&
      o.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr")
  ...
  function nb(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        L.hasData(e) &&
        ((s = L.access(e)), (a = L.set(t, s)), (c = s.events))
      )
        for (i in (delete a.handle, (a.events = {}), c))
          for (n = 0, r = c[i].length; r > n; n++) o.event.add(t, i, c[i][n]);
  ...
  (ib.optgroup = ib.option),
    ...
    o.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = ob(u), s = ob(e), r = 0, i = s.length; i > r; r++)
            pb(s[r], a[r]);
        if (t) {
          if (n)
            for (
              s = s || ob(e), a = a || ob(u), r = 0, i = s.length;
              i > r;
              r++
            )
              nb(s[r], a[r]);
        ...
        return (
          (a = ob(u, "script")).length > 0 && mb(a, !c && ob(e, "script")), u
        );
      },
      buildFragment: function (e, t, n, r) {
            ...
            if ("object" === o.type(i)) o.merge(p, i.nodeType ? [i] : i);
              ...
              for (
                s = s || f.appendChild(t.createElement("div")),
                  u =
                    ib[(a = (bb.exec(i) || ["", ""])[1].toLowerCase())] ||
                    ib._default,
                  s.innerHTML = u[1] + i.replace(ab, "<$1></$2>") + u[2],
                  c = u[0];
                c--;
        ...
        for (f.textContent = "", d = 0; (i = p[d++]); )
          if (
            (!r || -1 === o.inArray(i, r)) &&
            ((l = o.contains(i.ownerDocument, i)),
            (s = ob(f.appendChild(i), "script")),
            l && mb(s),
            n)
          )
            for (c = 0; (i = s[c++]); ) fb.test(i.type || "") && n.push(i);
        return f;
      },
      cleanData: function (e) {
        for (
          var t, n, r, i, s, a, u = o.event.special, l = 0;
          void 0 !== (n = e[l]);
          l++
        ) {
          if (o.acceptData(n) && (s = n[L.expando]) && (t = L.cache[s])) {
            if ((r = Object.keys(t.events || {})).length)
              for (a = 0; void 0 !== (i = r[a]); a++)
                u[i] ? o.event.remove(n, i) : o.removeEvent(n, i, t.handle);
    ...
    o.fn.extend({
      ...
      remove: function (e, t) {
        for (
          var n, r = e ? o.filter(e, this) : this, i = 0;
          null != (n = r[i]);
          i++
        )
          t || 1 !== n.nodeType || o.cleanData(ob(n)),
            n.parentNode &&
              (t && o.contains(n.ownerDocument, n) && mb(ob(n, "script")),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (o.cleanData(ob(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
            ...
            if (
              ...
              try {
                for (; r > n; n++)
                  (t = this[n] || {}),
                    1 === t.nodeType &&
                      (o.cleanData(ob(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (i) {}
            }
      ...
      domManip: function (t, n) {
        ...
        if (
          p &&
          ((i = (r = o.buildFragment(t, this[0].ownerDocument, !1, this))
            .firstChild),
          1 === r.childNodes.length && (r = i),
          i)
        ) {
          for (a = (s = o.map(ob(r, "script"), kb)).length; p > f; f++)
            (u = r),
              f !== h &&
                ((u = o.clone(u, !0, !0)), a && o.merge(s, ob(u, "script"))),
              n.call(this[f], u, f);
          if (a)
            for (
              c = s[s.length - 1].ownerDocument, o.map(s, lb), f = 0;
              a > f;
              f++
            )
              (u = s[f]),
                fb.test(u.type || "") &&
                  !L.access(u, "globalEval") &&
                  o.contains(c, u) &&
                  (u.src
                    ? o._evalUrl && o._evalUrl(u.src)
                    : o.globalEval(u.textContent.replace(hb, "")));
        }
        return this;
      },
    }),
    o.each(
      ...
      function (e, t) {
        o.fn[e] = function (e) {
          for (var n, r = [], i = o(e), s = i.length - 1, a = 0; s >= a; a++)
  ...
  function sb(e, t) {
    var n = o(t.createElement(e)).appendTo(t.body),
      r = a.getDefaultComputedStyle
        ? a.getDefaultComputedStyle(n[0]).display
        : o.css(n[0], "display");
    return n.detach(), r;
  }
  function tb(e) {
  ...
  function Hb(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += o.css(e, n + R[s], !0, i)),
        r
          ? ("content" === n && (a -= o.css(e, "padding" + R[s], !0, i)),
            "margin" !== n && (a -= o.css(e, "border" + R[s] + "Width", !0, i)))
          : ((a += o.css(e, "padding" + R[s], !0, i)),
            "padding" !== n &&
              (a += o.css(e, "border" + R[s] + "Width", !0, i)));
    return a;
  }
  function Ib(e, t, n) {
    var r = !0,
    ...
    if (0 >= i || null == i) {
      if (
        ((0 > (i = xb(e, t, s)) || null == i) && (i = e.style[t]), vb.test(i))
      )
        return i;
      (r = a && (l.boxSizingReliable() || i === e.style[t])),
        (i = parseFloat(i) || 0);
    }
  ...
  function Jb(e, t) {
    for (var n, r, i, s = [], a = 0, u = e.length; u > a; a++)
      (r = e[a]).style &&
        ...
        (n = r.style.display),
        t
          ? (s[a] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              S(r) &&
              (s[a] = L.access(r, "olddisplay", tb(r.nodeName))))
          : s[a] ||
            ((i = S(r)),
            ((n && "none" !== n) || !i) &&
              L.set(r, "olddisplay", i ? n : o.css(r, "display"))));
    for (a = 0; u > a; a++)
      (r = e[a]).style &&
        ((t && "none" !== r.style.display && "" !== r.style.display) ||
          (r.style.display = t ? s[a] || "" : "none"));
    return e;
  }
  ...
  o.extend({
    ...
    css: function (e, t, n, r) {
      ...
      return (
        ...
        "" === n || n
          ? ((s = parseFloat(i)), !0 === n || o.isNumeric(s) ? s || 0 : i)
          : i
      );
    },
  }),
      ...
      o.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return Gb(
            ...
            n,
            r
              ? Hb(e, t, r, "border-box" === o.css(e, "boxSizing", !1, i), i)
              : 0
          );
        },
      };
    ...
    (o.cssHooks.marginRight = yb(l.reliableMarginRight, function (e, t) {
      return t
        ? o.swap(e, { display: "inline-block" }, xb, [e, "marginRight"])
        : void 0;
    })),
        ...
        return J(
          ...
          function (e, t, n) {
            var r,
              ...
              a = 0;
            if (o.isArray(t)) {
              for (r = wb(e), i = t.length; i > a; a++)
                s[t[a]] = o.css(e, t[a], !1, r);
              return s;
            }
      ...
      _default: {
        ...
        set: function (e) {
          o.fx.step[e.prop]
            ? o.fx.step[e.prop](e)
            : e.elem.style &&
              (null != e.elem.style[o.cssProps[e.prop]] || o.cssHooks[e.prop])
    ...
    Qb = [
      function e(t, n, r) {
        ...
        1 === t.nodeType &&
          ...
          "none" === (f = o.css(t, "display")) && (f = tb(t.nodeName)),
          "inline" === f &&
            "none" === o.css(t, "float") &&
      ...
      "*": [
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            a =
              (o.cssNumber[e] || ("px" !== s && +r)) &&
              Ob.exec(o.css(n.elem, e)),
            u = 1,
            l = 20;
          if (a && a[3] !== s) {
            (s = s || a[3]), (i = i || []), (a = +r || 1);
  ...
  function Ub(e, t, n) {
    for (
      var r, i = (Rb[t] || []).concat(Rb["*"]), o = 0, s = i.length;
      s > o;
      o++
    )
    ...
    var r,
      ...
      l = function () {
        ...
        for (
          ...
          c.tweens[a].run(s);
        return (
          u.notifyWith(e, [c, s, n]),
          1 > s && l ? n : (u.resolveWith(e, [c]), !1)
        );
      },
      c = u.promise({
        elem: e,
      ...
      (function e(t, n) {
        ...
        for (r in t)
          if (
            ((s = n[(i = o.camelCase(r))]),
            (a = t[r]),
            o.isArray(a) && ((s = a[1]), (a = t[r] = a[0])),
            r !== i && ((t[i] = a), delete t[r]),
            (u = o.cssHooks[i]) && ("expand" in u))
          )
            for (r in ((a = u.expand(a)), delete t[i], a))
              (r in t) || ((t[r] = a[r]), (n[r] = s));
          else n[i] = s;
  ...
  (o.Animation = o.extend(Xb, {
    ...
    (c = (b = m.createElement("select")).appendChild(
    ...
    o.extend({
      attr: function (e, t, n) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return typeof e.getAttribute === U
            ...
            : ((1 === s && o.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r = o.attrHooks[t] || (o.expr.match.bool.test(t) ? Zb : Yb))),
              void 0 === n
      ...
      removeAttr: function (e, t) {
        ...
        if (s && 1 === e.nodeType)
          for (; (n = s[i++]); )
            (r = o.propFix[n] || n),
              o.expr.match.bool.test(n) && (e[r] = !1),
              e.removeAttribute(n);
      },
      attrHooks: {
        type: {
      ...
      if ("string" == typeof e && e) {
        for (t = (e || "").match(E) || []; l > u; u++)
          if (
            (r =
              1 === (n = this[u]).nodeType &&
              (n.className ? (" " + n.className + " ").replace(ac, " ") : " "))
          ) {
            for (s = 0; (i = t[s++]); )
              0 > r.indexOf(" " + i + " ") && (r += i + " ");
        ...
        : this.each(
            o.isFunction(e)
              ...
              : function () {
                  if ("string" === n)
                    for (
                      var t, r = 0, i = o(this), s = e.match(E) || [];
                      (t = s[r++]);
  ...
  o.fn.extend({
    ...
    o.extend({
      valHooks: {
        select: {
              ...
              if (
                !(
                  ...
                  (n.parentNode.disabled &&
                    o.nodeName(n.parentNode, "optgroup"))
                )
              ) {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, s = o.makeArray(t), a = i.length;
              a--;

            )
              ((r = i[a]).selected = o.inArray(o(r).val(), s) >= 0) && (n = !0);
    ...
    o.each(["radio", "checkbox"], function () {
      (o.valHooks[this] = {
        set: function (e, t) {
          return o.isArray(t)
            ? (e.checked = o.inArray(o(e).val(), t) >= 0)
            : void 0;
        },
      }),
        l.checkOn ||
  ...
  (ec = mc.exec(fc.toLowerCase()) || []),
    o.extend({
      ...
      ajax: function (e, t) {
        ...
        var n,
          ...
          b = {
            ...
            getResponseHeader: function (e) {
              ...
              if (2 === $) {
                if (!s)
                  for (s = {}; (t = ic.exec(i)); ) s[t[1].toLowerCase()] = t[2];
                t = s[e.toLowerCase()];
              }
        ...
        f.hasContent ||
          (f.data &&
            ((r = f.url += (dc.test(r) ? "&" : "?") + f.data), delete f.data),
          !1 === f.cache &&
            (f.url = hc.test(r)
              ? r.replace(hc, "$1_=" + cc++)
              : r + (dc.test(r) ? "&" : "?") + "_=" + cc++)),
        f.ifModified &&
          (o.lastModified[r] &&
            b.setRequestHeader("If-Modified-Since", o.lastModified[r]),
          o.etag[r] && b.setRequestHeader("If-None-Match", o.etag[r])),
        ...
        b.setRequestHeader(
          ...
          f.dataTypes[0] && f.accepts[f.dataTypes[0]]
            ? f.accepts[f.dataTypes[0]] +
                ("*" !== f.dataTypes[0] ? ", " + pc + "; q=0.01" : "")
            : f.accepts["*"]
        ),
        f.headers))
          b.setRequestHeader(c, f.headers[c]);
        if (f.beforeSend && (!1 === f.beforeSend.call(p, b, f) || 2 === $))
          return b.abort();
        for (c in ((x = "abort"), { success: 1, error: 1, complete: 1 }))
          b[c](f[c]);
        if ((n = sc(oc, f, t, b))) {
          (b.readyState = 1),
        ...
        function w(e, t, s, u) {
          ...
          2 !== $ &&
            ...
            s &&
              (x = (function e(t, n, r) {
                for (
                  var i, s, a, u, l = t.contents, c = t.dataTypes;
                  "*" === c[0];

                )
                  c.shift(),
                    void 0 === i &&
                      (i = t.mimeType || n.getResponseHeader("Content-Type"));
                if (i) {
                  for (s in l)
                    if (l[s] && l[s].test(i)) {
                      c.unshift(s);
            ...
            (x = (function e(t, n, r, i) {
              ...
              for (a = p.shift(); a; )
                if (
                  ...
                  !c && i && t.dataFilter && (n = t.dataFilter(n, t.dataType)),
                  (c = a),
                  (a = p.shift()))
                ) {
                  if ("*" === a) a = c;
            ...
            c
              ? (f.ifModified &&
                  ((_ = b.getResponseHeader("Last-Modified")) &&
                    (o.lastModified[r] = _),
                  (_ = b.getResponseHeader("etag")) && (o.etag[r] = _)),
                204 === e || "HEAD" === f.type
                  ? (w = "nocontent")
                  : 304 === e
                  ? (w = "notmodified")
                  : ((w = x.state), (m = x.data), (c = !(y = x.error))))
    ...
    o.each(["get", "post"], function (e, t) {
      o[t] = function (e, n, r, i) {
        return (
          ...
          o.ajax({ url: e, type: t, dataType: i, data: n, success: r })
        );
      };
    }),
    o.each(
  ...
  (o.param = function (e, t) {
    var n,
      r = [],
      i = function (e, t) {
        (t = o.isFunction(t) ? t() : null == t ? "" : t),
          (r[r.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t));
      };
    if (
      (void 0 === t && (t = o.ajaxSettings && o.ajaxSettings.traditional),
  ...
  o.ajaxSetup({
    ...
    o.ajaxPrefilter("json jsonp", function (e, t, n) {
      ...
      return u || "jsonp" === e.dataTypes[0]
        ? ((r = e.jsonpCallback =
            o.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
          u
            ? (e[u] = e[u].replace(Hc, "$1" + r))
            : !1 !== e.jsonp &&
              (e.url += (dc.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
          ...
          n.always(function () {
            (a[r] = i),
              e[r] && ((e.jsonpCallback = t.jsonpCallback), Gc.push(r)),
              s && o.isFunction(i) && i(s[0]),
              (s = i = void 0);
          }),
          "script")
        : void 0;
    ...
    (o.parseHTML = function (e, t, n) {
      ...
      return r
        ? [t.createElement(r[1])]
        : ((r = o.buildFragment([e], t, i)),
          i && i.length && o(i).remove(),
  ...
  (o.offset = {
    setOffset: function (e, t, n) {
      ...
      "static" === f && (e.style.position = "relative"),
        ...
        (l = o.css(e, "left")),
        (c =
          ("absolute" === f || "fixed" === f) && (s + l).indexOf("auto") > -1)
          ? ((a = (r = p.position()).top), (i = r.left))
        ...
        if (this[0]) {
          ...
          return (
            "fixed" === o.css(n, "position")
              ...
              : ((e = this.offsetParent()),
                (t = this.offset()),
                o.nodeName(e[0], "html") || (r = e.offset()),
                (r.top += o.css(e[0], "borderTopWidth", !0)),
                (r.left += o.css(e[0], "borderLeftWidth", !0))),
            {
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !o.nodeName(e, "html") && "static" === o.css(e, "position");
            ...
            function (e, r, i) {
              ...
              return void 0 === i
                ? s
                  ...
                  : e[r]
                : void (s
                    ? s.scrollTo(n ? a.pageXOffset : i, n ? i : a.pageYOffset)
                    : (e[r] = i));
            },
            e,
            r,
    ...
    o.each(["top", "left"], function (e, t) {
      o.cssHooks[t] = yb(l.pixelPosition, function (e, n) {
        return n
          ? ((n = xb(e, t)), vb.test(n) ? o(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
